...
android {
    namespace = "ru.dmdp.tishina.feature.about"
...
dependencies {
    // FR-21 — `Icons.Filled.OpenInNew` (links), `Icons.AutoMirrored.Outlined.ArrowBack`
    // (TopBar nav) and other Material symbols used by the rewritten AboutScreen.
